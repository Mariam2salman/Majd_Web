    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CommercialRegister = Input.CommercialRegister;
                var result = await _userManager.CreateAsync(user, Input.Password);

                if (result.Succeeded)
                {   //add user to employer role
                    var addRole = await _userManager.AddToRoleAsync(user, "Employer");
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ApplicationUser)}'. " +
                    ...
                    $"override the register page in /Areas/Identity/Pages/Account/EmployerRegister.cshtml");
            }
        }
