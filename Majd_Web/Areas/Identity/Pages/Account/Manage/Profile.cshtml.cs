...
namespace Majd_Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "الوصف أو السيرة الشخصية")]

            public string? About { get; set; }
            [Display(Name = "مقر الشركة")]
            public string? Headquarter { get; set; }
            [Display(Name = "رابط موقع للشركة")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Headquarter != user.Headquarter)
            {
                user.Headquarter = Input.Headquarter;
                await _userManager.UpdateAsync(user);

            }

            if (Input.UrlLocation != user.UrlLocation)
            {
                user.UrlLocation = Input.UrlLocation;
                await _userManager.UpdateAsync(user);

            }
            if (Input.CareerSectore != user.CareerSectore)
            {
                user.CareerSectore = Input.CareerSectore;
                await _userManager.UpdateAsync(user);
